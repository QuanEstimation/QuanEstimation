...
M = [np.dot(M_basis[i].reshape(-1, 1), M_basis[i].reshape(1, -1).conj()) for i in range(M_num)]
# dynamics
...
AD_paras = {"Adam":False, "psi0":psi0, "max_episode":30, "epsilon":0.01, "beta1":0.90, "beta2":0.99}
...
PSO_paras = {"particle_num":10, "psi0":psi0, "max_episode":[100, 10], "c0":1.0, "c1":2.0, "c2":2.0, "seed":1234}
...
DE_paras = {"popsize":10, "psi0":psi0, "max_episode":100, "c":1.0, "cr":0.5, "seed":1234}
...
NM_paras = {"state_num":20, "psi0":psi0, "max_episode":100, "ar":1.0, "ae":2.0, "ac":0.5, "as0":0.5, "seed":1234}
