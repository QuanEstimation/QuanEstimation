...
AD_paras = {"Adam":False, "psi0":[], "ctrl0":ctrl0, "measurement0":[np.array(C)], "max_episode":10, "epsilon":0.01, "beta1":0.90, "beta2":0.99, "seed":1234}
...
PSO_paras = {"particle_num":10, "psi0":[], "ctrl0":ctrl0, "measurement0":[np.array(C)], "max_episode":[100,10], "c0":1.0, "c1":2.0, "c2":2.0, "seed":1234}
...
DE_paras = {"popsize":10, "psi0":[], "ctrl0":ctrl0, "measurement0":[np.array(C)], "max_episode":100, "c":1.0, "cr":0.5, "seed":1234}
