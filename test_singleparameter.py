...
DDPG_paras = {'layer_num':4, 'layer_dim':250, 'max_episodes':500, 'seed':4321}

ctrlopt = ControlOpt(tspan, rho0, H0, Hc_ctrl, dH0, Hc_coeff, L_opt, gamma, ctrl_bound=[-1.0,1.0], method='DDPG', **DDPG_paras)
