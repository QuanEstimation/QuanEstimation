...
DE_paras = {'popsize':10, 'ini_population':[], 'max_episodes':1000, 'c':1.0, 'cr':0.5, 'seed':1234}

ctrlopt = ControlOpt(tspan, rho0, H0, Hc_ctrl, dH0, Hc_coeff, L_opt, gamma, ctrl_bound=[-0.1,0.1], method='GRAPE', **GRAPE_paras)
