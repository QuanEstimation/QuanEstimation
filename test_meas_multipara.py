...
AD_paras = {'Adam':False, 'measurement0':[Measurement], 'max_episode':300, 'epsilon':0.001, 'beta1':0.90, 'beta2':0.99}
...
Measopt = MeasurementOpt(tspan, rho0, H0, dH0, decay, mtype='projection', mgiven=[], method='DE', **DE_paras)
