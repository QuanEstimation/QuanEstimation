...
function DDPG_QFIM(params::TimeIndepend_noiseless, layer_num, layer_dim, seed, max_episode, save_file)
    rng = StableRNG(seed)
...
function DDPG_CFIM(Measurement, params::TimeIndepend_noiseless, layer_num, layer_dim, seed, max_episode, save_file)
    rng = StableRNG(seed)
...
function DDPG_QFIM(params::TimeIndepend_noise, layer_num, layer_dim, seed, max_episode, save_file)
    rng = StableRNG(seed)
...
function DDPG_CFIM(Measurement, params::TimeIndepend_noise, layer_num, layer_dim, seed, max_episode, save_file)
    rng = StableRNG(seed)
