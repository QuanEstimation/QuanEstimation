...
GRAPE(;max_episode=300, ϵ=0.01, beta1=0.90, beta2=0.99, Adam::Bool=true) = Adam ? GRAPE_Adam(max_episode, ϵ, beta1, beta2) : GRAPE(max_episode, ϵ)
...
autoGRAPE(;max_episode=300, ϵ=0.01, beta1=0.90, beta2=0.99, Adam::Bool=true) = Adam ? autoGRAPE_Adam(max_episode, ϵ, beta1, beta2) : autoGRAPE(max_episode, ϵ)
...
AD(max_episode, ϵ, beta1, beta2) = AD_Adam(max_episode=max_episode, ϵ=ϵ, beta1=beta1, beta2=beta2)
AD(;max_episode=300, ϵ=0.01, beta1=0.90, beta2=0.99, Adam::Bool=true) = Adam ? AD_Adam(max_episode, ϵ, beta1, beta2) : AD(max_episode, ϵ)
