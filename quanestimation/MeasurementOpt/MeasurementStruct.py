   ...
   > **measurement0:** `list of arrays`
    ...
    def dynamics(self, tspan, rho0, H0, dH, Hc=[], ctrl=[], decay=[], dyn_method="expm"):
        ...
        if self.mtype == "projection":
            ...
            self.opt = jl.QuanEstimation.Mopt_Projection(M=self.C, seed=self.seed)
            ...
            if self.minput[0] == "LC":
                ...
                self.opt = jl.QuanEstimation.Mopt_LinearComb(
                ...
                self.opt = jl.QuanEstimation.Mopt_Rotation(
    ...
    def Kraus(self, rho0, K, dK):
        ...
        self.dynamic = jl.QuanEstimation.Kraus(self.rho0, self.K, self.dK)
        self.output = jl.QuanEstimation.Output(self.opt, save=self.savefile)
    ...
    def CFIM(self, W=[]):
        ...
        self.obj = jl.QuanEstimation.CFIM_obj(
