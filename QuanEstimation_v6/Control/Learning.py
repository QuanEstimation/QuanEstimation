...
class DDPG(object):
    def __init__(self, a_dim, s_dim, action_bound, actor_hidn_dim=200, critic_hidn_dim=200, actor_layer=2, critic_layer=1,\
                 buffer_capacity=10000, batch_size=32, gamma=0.95, tau=0.02, actor_lr=0.001, critic_lr=0.002):
        """
        ---------
        Inputs
        ---------
        ...
        self.pointer = 0
        self.actor_eval = ddpg_actor(s_dim,a_dim,actor_hidn_dim,action_bound,actor_layer)
        self.actor_target = ddpg_actor(s_dim,a_dim,actor_hidn_dim,action_bound,actor_layer)
...
class ddpg_actor(nn.Module):  
    def __init__(self,s_dim,a_dim,actor_hidn_dim,action_bound,actor_layer):
