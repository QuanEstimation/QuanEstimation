...
jl.include("./Common/GRAPE_AD.jl")

Main.include('./Control/Gradient.jl')

class GRAPE_without_adam(Lindblad, CramerRao):
    ...
    def GRAPE_QFI(self, env_assisted=False):
        ...
        Hc_coeff = Main.Gradient.gradient_QFI(self, dH0, Hc_coeff, D, SLD_final)
