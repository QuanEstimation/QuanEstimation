...
DDPG_paras = {'layer_num':4, 'layer_dim':220, 'max_episodes':500, 'seed':200}

ctrlopt = ControlOpt(tspan, rho0, H0, Hc_ctrl, dH0, Hc_coeff, L_opt, gamma, ctrl_bound=[-0.1,0.1], method='DDPG', **DDPG_paras)
